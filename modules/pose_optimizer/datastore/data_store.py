...
class DataStore:
    ...
    def __init__(self):
        self.feature_points = FeaturePointsStore()
    ...
    def add_new_keyframe(self,
        ...
        for i, bundle in enumerate(bunldes):
            ...
            if feature_point_id in self.feature_points.ids:
                bundles.pop(i)
                feature_piint_index = self.feature_points.ids.index(feature_point_id)
