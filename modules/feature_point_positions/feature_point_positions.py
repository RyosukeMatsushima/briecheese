...
class FeatuePointPositions:
    def __init__(self):
        ...
        self.one_piece_length_threshold_to_optimize = 10
    ...
    def calculate_feature_point_positions(self, one_piece):
        ...
        for keyframe_id in one_piece.keyframes:
            keyframe_number = optimizer.add_keyframe(
                Keyframe(
                    one_piece.keyframes[keyframe_id].observed_position,
                    one_piece.keyframes[keyframe_id].observed_roattion,
                    one_piece.keyframes[keyframe_id].observed_position,
                    one_piece.keyframes[keyframe_id].observed_roattion,
                    []
                )
        ...
        for feature_point_id in one_piece.feature_point_ids:
            keyframe_number = feature_point_ids_and_numbers[feature_point_id]
            position = optimizer.feature_point_positions[feature_point_number]
