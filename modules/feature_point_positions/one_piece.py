...
ObservedData = namedtuple('observed_position', 'observed_rotation')
...
class OnePiece:
    ...
    def add_keyframe(
        ...
        if self.feature_point_ids:
            ...
            if len(related_feature_point_directions) < self.available_feature_points_count_threshold:
                return
        ...
        self.keyframes.update({self.keyframe_number: ObservedData(observed_position=observed_position, observed_rotation=observed_roattion)})
