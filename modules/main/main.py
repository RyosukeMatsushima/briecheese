...
class Main:
    ...
    def get_feature_point_directions(self, frame):
        ...
        for feature_point_pixel in feature_point_pixels:
            feature_point_direction = self.featurePointDirection.get(feature_point_pixel[0][0], feature_point_pixel[0][1])

            feature_point_directions.append([feature_point_pixel[1], feature_point_direction])
